...
$style="";
if ( is_active_sidebar( 'pixel-banner-sidebar' ) ) : 
    dynamic_sidebar('pixel-banner-sidebar');
endif;?>
        ...
        <div class="row">
            <div class="tbeer-main-content col-md-8 col-sm-8 col-xs-12">
                <div class="tbeer-left-sidebar col-md-4 col-sm-12 col-xs-12"><?php
                    if ( is_active_sidebar( 'pixel-category-sidebar' ) ) : 
                        dynamic_sidebar('pixel-category-sidebar');
                    endif;
                    ?>                  
                </div>
