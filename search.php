      ...
      <div class="row">
        ...
        <div class="tbeer-single-post-wrapper">
          ...
          <div class="tbeer-main-content col-md-8 col-sm-8 col-xs-12">
              ...
              <h3 class="tbeer-section-title"><?php _e('Search Results','pixel');?></h3>
            ...
            <div class="tbeer-search-result-wrapper">
              ...
              if(have_posts()):
                    ...
                    <div class="tbeer-search-result">
                        ...
                        <div class="tbeer-search-result-details">
                          ...
                          <a href="<?php the_permalink();?>"><?php the_title();?></a>
                            ...
                            <p class="tbeer-news-post-excerpt"><?php echo pixel_the_excerpt_max_charlength(100); ?></p>
                ...
                endwhile;
                  ...
                  echo __('<h2>No results found</h2>','pixel');
