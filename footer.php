            ...
            <div class="tbeer-footer-bottom">
                ...
                <div class="container">
                    ...
                    <div class="row">
                     ...
                     <?php if($pixel_options['footer_copyright']):?>

                        <div class="tbeer-copyright-info">

                            <p><?php echo wp_kses_post($pixel_options['footer_copyright']);?></p>
...
<?php if(isset($pixel_options['meta_javascript']) && $pixel_options['meta_javascript']!='')

echo wp_kses_post($pixel_options['meta_javascript']); ?>
