...
add_action( 'add_meta_boxes', 'pixel_add_post_format_metabox' );



function pixel_add_post_format_metabox() {
    ...
    if ( ! empty( $metaboxes ) ) {
        ...
        foreach ( $metaboxes as $id => $metabox ) {
            ...
            add_meta_box( $id, $metabox['title'], 'pixel_show_metaboxes', $metabox['applicableto'], $metabox['location'], $metabox['priority'], $id );
...
function pixel_show_metaboxes( $post, $args ) {
...
add_action( 'save_post', 'pixel_save_metaboxes' );



function pixel_save_metaboxes( $post_id ) {
...
add_action( 'admin_print_scripts', 'pixel_display_metaboxes', 1000 );

function pixel_display_metaboxes() {
...
add_filter( 'cmb_meta_boxes', 'pixel_cmb_metaboxes' );

function pixel_cmb_metaboxes( array $meta_boxes ) {
    ...
    $prefix = 'pixel_';
     ...
     $meta_boxes['page_metabox'] = array(
        ...
        'title'      => __( 'Creativ Page Settings', 'pixel' ),
        ...
        'fields'     => array(
            ...
            array(
                ...
                'name'    => __( 'Select Template Background Color','pixel'),

                'desc' => __('Background color of selected template will change accordingly except builder templates', 'pixel') ,
            ...
            array(
                ...
                'name'    => __( 'Page Breadcrumb Options','pixel'),
            ...
            array(
                ...
                'name' => __('Background Breadcrumb Image', 'pixel') ,

                'desc' => __('Upload an image or enter a URL. This works only for Breadcrumb Background Image style.', 'pixel') ,
            ...
            array(
                ...
                'name' =>  __( 'Hide Social Icons', 'pixel' ),
    ...
    $meta_boxes['post_metabox'] = array(
        ...
        'title'      => __( 'Creativ Post Page Settings', 'pixel' ),
     ...
     $meta_boxes['portfolio_metabox'] = array(
        ...
        'title'      => __( 'Custom Portfolio Options', 'pixel' ),
    ...
    $meta_boxes['event_metabox'] = array(
            ...
            'title'      => __( 'Custom Event Options', 'pixel' ),
     ...
     $meta_boxes['menu_metabox'] = array(
            ...
            'title'      => __( 'Custom Menu Options', 'pixel' ),
